...
# Load Yolo
net = cv2.dnn.readNet("/Users/Lenovo/Downloads/Homework2/yolov3.weights", "/Users/Lenovo/Downloads/Homework2/yolov3.cfg")
layer_names = net.getLayerNames()
output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers().flatten()]

# Load names of classes
classes = None
with open('/Users/Lenovo/Downloads/Homework2/yolov3.txt', 'r') as f:
...
# Open the video file
cap = cv2.VideoCapture(r'/Users/Lenovo/Downloads/Task 4/tracking.mp4')
